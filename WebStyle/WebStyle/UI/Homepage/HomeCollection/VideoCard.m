...
-(void)create
{
    _videoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.width, movieCardImgHeight)];
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(2, 0, self.width - 4, self.height * 0.125)];
