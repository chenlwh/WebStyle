...
//缓冲条
@property(nonatomic,retain)UIProgressView *cacheProgressView;
...
- (void)changeFrame{
    ...
    self.playOrPauseBtn.frame = CGRectMake((_backView.width - 40)/2, (_backView.height - 40)/2, 40, 40);
    ...
    self.fullScreenBtn.frame = CGRectMake(_bottomView.width-40 - 2, (_bottomView.height-40)/2,40 ,40);
