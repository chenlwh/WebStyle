...
- (void)initSubView
{
    ...
    UIView *seprateView = [[UIView alloc] initWithFrame:CGRectMake(0, cellHeight - 10, cellWidth, 10)];
    [self.contentView addSubview:seprateView];
    seprateView.backgroundColor = [UIColor hexStringToColor:@"0xeeeeee"];
    ...
    UIImageView *maskBottomImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, cellWidth , 33)];
    [maskBottomImage setImage:[UIImage imageNamed:@"bk_mask_bottom"]];
    [self addSubview:maskBottomImage];
    maskBottomImage.transform = CGAffineTransformMakeScale(1.0,-1.0);
...
- (void)layoutSubviews
{
    ...
    [self.imgView sd_setImageWithURL:[NSURL URLWithString:_model.vedioimage] placeholderImage:nil];
    
     self.titleLabel.text = _model.vedioDesc;
}
