...
- (void)layoutSubviews {
    ...
    if (self.forceLabelTextWidth) {
        label.numberOfLines = 0;
        labelSize = MB_MULTILINE_TEXTSIZE(labelText, label.font, CGSizeMake(self.forceLabelTextWidth.floatValue, CGFLOAT_MAX), label.lineBreakMode);
    }
...
- (void)setTransformForCurrentOrientation:(BOOL)animated {
    ...
    UIInterfaceOrientation orientation = UIInterfaceOrientationPortraitUpsideDown;
    if (hasApplication) {
