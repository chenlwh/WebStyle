...
- (void)setUp
{
    ...
    _scrollView = [[[self scrollViewClass] alloc] init];
...
- (void)loadUnloadViews
{
    ...
    if (itemWidth)
    {
        ...
        //add by wushengtao start
        if([_dataSource respondsToSelector:@selector(numberOfVisibleItemsInSwipeView:)])
        {
            numberOfVisibleItems = [_dataSource numberOfVisibleItemsInSwipeView:self];
        }
        //add by wushengtao end
